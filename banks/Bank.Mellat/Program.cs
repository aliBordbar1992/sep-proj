...
string BankIdentificationNumber = "610433";

bool shouldDelay = true;

app.MapGet("/get-identification-number", () =>
    {
        Console.WriteLine("called GetIdentificationNumber");
        if (shouldDelay)
        {
            Console.WriteLine("delay for 5000 ms");
            shouldDelay = false;
            Thread.Sleep(5000);
            Console.WriteLine("after delay");
        }
        return new BaseResponseDto<string>("Success", 0, BankIdentificationNumber);
    })
