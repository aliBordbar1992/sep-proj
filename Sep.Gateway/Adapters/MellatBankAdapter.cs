...
public class MellatBankAdapter : IBankAdapter
{
    private readonly IMellatBankPaymentProvider _provider;

    public MellatBankAdapter(IMellatBankPaymentProvider provider)
    {
        _provider = provider;
    }
