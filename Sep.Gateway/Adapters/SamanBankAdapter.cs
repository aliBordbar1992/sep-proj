...
public class SamanBankAdapter : IBankAdapter
{
    private readonly ISamanBankPaymentProvider _provider;


    public SamanBankAdapter(ISamanBankPaymentProvider provider)
    {
        _provider = provider;
    }
